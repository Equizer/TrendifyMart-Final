...
const EditProduct = (props) => {
  ...
  const { productDetails, setProductDetails, conditionState, setConditionState } = props
      ...
      <div className="modal-dialog modal-xl">
        <div className="modal-content">
          ...
          <div className="modal-footer">
            ...
            <button type="submit" className="btn btn-primary" data-bs-dismiss="modal" onClick={handleSave}>Save Changes</button>
          </div>
        </div>
      </div>
    </div>
